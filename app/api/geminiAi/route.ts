...
Also remember that the answer you will be giving will go inside tinymce editor and prismjs will be use to show it on the page, so format the text in html format. 
